...
class SymptomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create symptom" do
    assert_difference('Symptom.count') do
      post symptoms_url, params: { symptom: { artist_id: @symptom.artist_id, name: @symptom.name } }, as: :json
    end
  ...
  test "should update symptom" do
    patch symptom_url(@symptom), params: { symptom: { artist_id: @symptom.artist_id, name: @symptom.name } }, as: :json
    assert_response 200
  end
