...
@Schizoaffective = Resource.create!(name: "SARDAA", link: "https://sardaa.org/?gclid=CjwKCAjw4MP5BRBtEiwASfwAL8-EsIH4lLIv8pSAGGXdreHLDvK8tRvs-TF6rhtiHWDJAyh7mcoRDxoCxTkQAvD_BwE")
@MHA = Resource.create!(name: "Mental Health Association", link: "https://www.mhanational.org/conditions/schizoaffective-disorder")
...
@psychosis = Symptom.create!(name: "psychosis")
@mania = Symptom.create(name: "mania")
@depression = Symptom.create(name: "depression")
